...
build_json = open('D:/pobdCompare/tests/fixtures/builds/tie5.build', 'r', encoding='utf-8').read()
...
result = subprocess.run(
    ...
    input=json.dumps({'buildXml': build_json, 'skillNumber': 1, 'weaponSet': 1, 'config': {}}) + '\n',
    capture_output=True,
    text=True,
    encoding='utf-8',
    env=env,
