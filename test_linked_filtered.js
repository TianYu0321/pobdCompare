...
try {
  ...
  console.log('validNodeIds size:', validNodeIds.size);
  console.log('linked[1841]:', linked[1841]);
  console.log('linked[2021]:', linked[2021]);
  console.log('validNodeIds.has(9405):', validNodeIds.has(9405));
  console.log('validNodeIds.has(25857):', validNodeIds.has(25857));
} catch (e) {
